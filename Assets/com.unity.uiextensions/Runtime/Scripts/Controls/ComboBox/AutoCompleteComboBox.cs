    ...
    public class AutoCompleteComboBox : MonoBehaviour
    {
        ...
        private bool Initialize()
        {
            ...
            try
            {
                ...
                _inputRT = _rectTransform.Find("InputField (TMP)").GetComponent<RectTransform>();
        ...
        private void RebuildPanel()
        {
            ...
            for (int i = 0; i < itemObjs.Count; i++)
            {
                ...
                if (i < AvailableOptions.Count)
                {
                    ...
                    itemObjs[i].transform.Find("Text (TMP)").GetComponent<TMP_Text>().text = AvailableOptions[i]; //set the text value
        ...
        private void PruneItemsLinq(string currText)
        {
            ...
            var toPrune = _panelItems.Where(x => !x.StartsWith(currText)).ToArray();
            ...
            var toAddBack = _prunedPanelItems.Where(x => x.StartsWith(currText)).ToArray();
